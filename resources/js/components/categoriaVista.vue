      ...
      <div class="card">
        <div class="card-header">
             ...
             <div class="form-group col-md-2">
                ...
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#articuloModal"  style="position:relative; rigth:100px;">Crear Categoria</button>
               ...
               <th scope="col">Eliminar</th>
                ...
                <tbody>
                  <tr v-for="consul in consulta" :key="consul.id">
                    ...
                    <td> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#articuloeditarModal" v-on:click="traerCategoriaEditar(consul)">Editar</button></td>
                     <td><button type="button" class="btn btn-danger" v-on:click.prevent="eliminarCategoria(consul)" >Eliminar</button></td>
                  </tr>
                </tbody>
              </table>
        </div>
...
<div class="modal fade" id="articuloModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Nombre Articulo"  v-model="nombre_categoria">
  </div>
    
      <div class="form-group">
    <label for="formGroupExampleInput">Descripcion</label>
    <input type="text" class="form-control" id="formGroupExampleInput" v-model="descripcion_categoria" placeholder="Descripcion" >
  </div>
  <div class="modal-footer">
        ...
        <div v-else-if="nombre_categoria!='' && descripcion_categoria!='' ">
          <button type="button" v-on:click.prevent="guardarCategoria()" data-dismiss="modal"  class="btn btn-primary" >Guardar</button>
        </div>
      </div>
      </div>
      </form>
...
<div class="modal fade" id="articuloeditarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
    <label for="formGroupExampleInput">Nombre Categoria</label>
    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Nombre Articulo"  v-model="nombre_categoria_Editar">
  </div>
  {{this.id}}
      <div class="form-group">
    <label for="formGroupExampleInput">Descripcion Categoria</label>
    <input type="text" class="form-control" id="formGroupExampleInput" v-model="descripcion_categoria_Editar" placeholder="Descripcion" >
  </div>
  <div class="modal-footer">
        ...
        <div v-else-if="nombre_categoria_Editar!='' && descripcion_categoria_Editar!='' ">
          <button type="button" v-on:click.prevent="EditarCategoria()" data-dismiss="modal"  class="btn btn-primary" >Guardar</button>
        </div>
      </div>
      </div>
      </form>
...
console.log(consul.id);
     axios.post("api/eliminarCategoria",{
     id: consul.id
     }).then(response =>{
      this.addCategoria(); 
     });
