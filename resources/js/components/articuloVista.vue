 ...
 <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
            ...
            <td v-text="consul.codigo"></td>
                    ...
                    <td> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#articuloeditarModal" v-on:click.prevent="traerArticuloEditar(consul)">Editar</button></td>
                     <td><button type="button" class="btn btn-danger" v-on:click.prevent="eliminarArticulo(consul)" >Eliminar</button></td>
                  </tr>
                </tbody>
              </table>
=======
...
>>>>>>> 9018df1674f42ac585ea90308f98b78c07667778
        </div>
      </div>
    </div>
    <!-- Modal de articulos -->
...
<div class="modal fade" id="articuloModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="categoria" v-model="categoria" required>  
      ...
      <option v-for="consul1 in consulcat" :key="consul1.id" v-text="consul1.nombre_categoria" :value="consul1.id" >
  ...
  <div class="form-group" >
    ...
    <select  class="form-control" id="exampleFormControlSelect1" v-model="estado" required>
    ...
    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Nombre Articulo"  v-model="nombre">
  </div>
      <div class="form-group">
    <label for="formGroupExampleInput" >stock</label>
    
    <div  v-if="this.estado == 2 || this.estado == 3">
    <input type="number" class="form-control" id="formGroupExampleInput" placeholder="stock" value="0" disabled v-model="stock">
    </div>
    <div v-else-if="this.estado == 1">
      <input type="number" class="form-control" id="formGroupExampleInput" placeholder="stock" required  v-model="stock">
    </div>
    <div v-else>
       <input type="number" class="form-control" id="formGroupExampleInput" placeholder="stock" value="0" disabled v-model="stock" >
      </div>
    ...
    <input type="text" class="form-control" id="formGroupExampleInput" v-model="descripcion" placeholder="Descripcion" >
  </div>
  <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" v-on:click="limpiar()">Cerrar</button>
        <div v-if="estado ==0 || categoria ==''||codigo==''|| nombre=='' || descripcion==''">
...
<div class="modal fade" id="articuloeditarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="categoria" v-model="categoriaEditar" required>  
      ...
      <option v-for="consul1 in consulcat" :key="consul1.id" :value="consul1.id" v-text="consul1.nombre_categoria"  >
  ...
  <div class="form-group" >
    <label for="exampleFormControlSelect1">Estado</label>
    <select  class="form-control" id="exampleFormControlSelect1" v-model="estadoEditar" required>
      <option disabled value="0">seleccionar</option>
      <option value="1">Activado</option>
      <option value="2">Inactivo</option>
     <option value="3">Agotado</option>
      ...
      <div class="form-group">
    <label for="formGroupExampleInput">Nombre Articulo</label>
    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Nombre Articulo"  v-model="nombreEditar">
  </div>
      <div class="form-group">
    <label for="formGroupExampleInput" >stock</label>
    
    <div  v-if="this.estadoEditar == 2 || this.estadoEditar == 3">
    <input type="number" class="form-control" id="formGroupExampleInput" placeholder="stock" value="0" disabled v-model="stockEditar">
    </div>
    <div v-else-if="this.estadoEditar == 1">
      <input type="number" class="form-control" id="formGroupExampleInput" placeholder="stock" required  v-model="stockEditar">
    </div>
    <div v-else>
       <input type="number" class="form-control" id="formGroupExampleInput" placeholder="stock" value="0" disabled v-model="stockEditar" >
      </div>
      ...
      <div class="form-group">
    <label for="formGroupExampleInput">Descripcion</label>
    <input type="text" class="form-control" id="formGroupExampleInput" v-model="descripcionEditar" placeholder="Descripcion" >
  </div>
  <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" >Cerrar</button>
        <div v-if="estadoEditar ==0 || categoriaEditar ==''||codigoEditar==''|| nombreEditar=='' || descripcionEditar==''">
        <button type="submit" disabled class="btn btn-primary" data-dismiss="modal">Guardar</button>
        </div>
